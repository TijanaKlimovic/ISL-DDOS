...
/* JsonRequest{
	...
	jsonD request; ie header and body of a request

	ID()
	Query()
	Flags() getters belong to this structure
	
	([]byte, error) MarshaJSON() -> Marshals the follwoing structure H: header , B: body of self.request
}
